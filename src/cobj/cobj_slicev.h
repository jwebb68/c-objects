...
bool WARN_UNUSED_RESULT SliceV_try_copy(SliceV *const self, SliceV const *const src, Error *err);
...
// null if not valid pos
void *SliceVMut_try_get(SliceVMut const *const self, size_t pos, size_t elem_size);
...
SliceVMut_try_copy_from(SliceVMut *const self,
