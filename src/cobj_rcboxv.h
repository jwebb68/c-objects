...
void RCBoxV_destroy(RCBoxV *const self, void (*elem_destroy)(void *));
...
// bool WARN_UNUSED_RESULT RCBoxV_try_new_copy_T(RCBoxV *const self, T const *const v, Error *const err);
